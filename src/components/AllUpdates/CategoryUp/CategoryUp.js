...
const CategoryUp = () => {
  ...
  return (
    <div>
      ...
      <form className="py-5 text-sm"ha onSubmit={handleCategoryUpdate}>
          {
            idByCategoryData ? (
              <div className="">
              <div className="card p-5 w-8/12">
               ...
               <div className="py-4">
                 ...
                 <i class="fa-solid me-2 fa-arrow-left"></i> Back to Category List
                 </button>
               </Link>
                 </div>
                 <input
                   ...
                   <div class="upload-area">
                     <div class="drag-drop">
                       ...
                       <input
                         ...
                         name="image"
                         id="file-upload"
                         defaultValue={idByCategoryData.image}
               ...
               <div>
              {
                ...
                <><img className="w-40 h-32 pb-4" src={idByCategoryData.image} alt="" /></>
              }
            </div>
              <div>
                {
